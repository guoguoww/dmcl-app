        ...
        <div class="container">
          <div class="sec-top">
            ...
            <div class="app-down clearfix">
              <div class="f-left">
                <a :class="downloadChoose === 'android'? 'active' : ''" @click="downloadChoose = 'android'">Android下载</a>
                <a :class="downloadChoose === 'ios'? 'active' : ''" @click="downloadChoose = 'ios'">iOS下载</a>
              </div>
              <div class="f-right">
                <img v-if="downloadChoose === 'android'" src="../../../public/img/ncl-app.jpg" alt="">
                <img v-if="downloadChoose === 'ios'" src="../../../public/img/ncl-wechat.jpg" alt="">
                <span>扫二维码下载</span>
              </div>
            </div>
          </div>
...
<style scoped>
  ...
  .weixinban .section2 {
    background: url(../../../public/img/phone-bg3.jpg) no-repeat center center;
    background-size: cover;
  }
